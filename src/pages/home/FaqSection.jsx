    ...
    return (
        ...
        >
            <div className="w-full px-[24px] py-[22px] flex items-center justify-start gap-[16px]">
                ...
                <h4 className="text-white font-['Montserrat'] font-bold text-[16px] leading-[1.2]">
                    {faq.question}
                </h4>
            </div>
            ...
            <AnimatePresence initial={false}>
                {isOpen && (
                    ...
                    >
                        <div className="px-[24px] pl-[60px] text-[#556761] font-['Montserrat'] font-medium text-[14px] leading-[1.6]">
                            {faq.answer}
                        </div>
                    </motion.div>
                )}
