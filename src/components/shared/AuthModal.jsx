            ...
            {isOpen && (
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
                    ...
                    >
                        ...
                        <div 
                            className="hidden md:flex flex-col items-center w-[400px] shrink-0 relative overflow-hidden"
                            style={{
                                backgroundImage: `url('${sideframeImg}')`,
                                backgroundSize: 'cover',
                                backgroundPosition: 'center'
                            }}
                        >
                            {/* The sideframeImg already contains all the promotional text and graphics */}
                        </div>
                        ...
                        <div className="flex-1 p-6 md:p-8 flex flex-col relative bg-[#0c1311] overflow-y-auto custom-scrollbar">
                            ...
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <button 
                                    onClick={onClose}
                                    className="w-8 h-8 flex items-center justify-center rounded-lg bg-[#16211e] hover:bg-[#1f2e29] transition-colors text-gray-400 hover:text-white"
                                >
                                    <X size={18} />
                                </button>
                            </div>
                            ...
                            <div className="flex items-center bg-[#16211e] rounded-xl p-1 mb-8 w-full">
                                <button
                                    ...
                                    className={`flex-1 py-2.5 rounded-lg text-sm font-bold transition-all ${mode === 'signin' ? 'bg-[#107015] text-white shadow-lg' : 'text-gray-400 hover:text-white'}`}
                                >
                                    Sign In
                                </button>
                                <button
                                    onClick={() => setMode('signup')}
                                    className={`flex-1 py-2.5 rounded-lg text-sm font-bold transition-all ${mode === 'signup' ? 'bg-[#107015] text-white shadow-lg' : 'text-gray-400 hover:text-white'}`}
                                >
                                    Sign Up
                                </button>
                            </div>
                            ...
                            <form className="flex flex-col gap-4 mb-6">
                                ...
                                {mode === 'signup' && (
                                    <div className="flex items-start gap-3 mt-2">
                                        ...
                                        <label htmlFor="terms" className="text-gray-400 text-sm leading-tight select-none cursor-pointer">
                                            By accessing I confirm that I'm at least 18 yo and agree to the <a href="#" className="text-white hover:underline">Terms of Service</a>
                                        </label>
                                    </div>
                                )}
                                ...
                                <button 
                                    type="button"
                                    className="w-full h-[54px] mt-4 rounded-xl bg-gradient-to-r from-[#107015] to-[#68E203] text-white font-bold text-[17px] hover:opacity-90 transition-opacity shadow-[0_0_20px_rgba(104,226,3,0.2)]"
                                >
                            ...
                            <div className="flex items-center gap-4">
                                <button className="flex-1 h-[50px] bg-[#16211e] hover:bg-[#1f2e29] rounded-xl flex items-center justify-center transition-colors border border-white/5">
